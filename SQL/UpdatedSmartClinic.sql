...
SHOW CREATE VIEW AppointmentDetails;
...
WHERE TABLE_SCHEMA = 'smartclinic'
AND TABLE_NAME = 'AppointmentDetails';

SELECT * FROM AppointmentDetails;

SHOW TRIGGERS;

SHOW CREATE TRIGGER CheckPaymentAmount;

INSERT INTO Payments
(PaymentID, PatientID, PaymentDate, Amount, PaymentMethod)
VALUES
(6, 1, '2026-08-09', -100, 'Cash');
...
INSERT INTO Medicines
(MedicineID, MedicineName, Dosage, Price)
VALUES
(5, 'Omeprazole', '20 mg', 0);

SELECT *
FROM Medicines
WHERE MedicineID IN (1,2,3,4);
...
SELECT MedicineID, MedicineName, Dosage, Price, Manufacturer
FROM Medicines
ORDER BY MedicineID;
...
INSERT INTO Medicines
(MedicineID, MedicineName, Dosage, Manufacturer)
VALUES
(5, 'Omeprazole', '20 mg', 'AstraZeneca');
...
INSERT INTO Prescriptions
(PrescriptionID, PatientID, DoctorID, MedicineID, PrescriptionDate)
VALUES
(5, 5, 5, 5, '2026-08-04');
